...
var arraySorter = {
  SortBubble: function SortBubble(srcArray) {
    for (var i = 0; i < srcArray.length - 1; i++) {
      for (var j = 0; j < srcArray.length - 1; j++) {
        if (srcArray[j] > srcArray[j + 1]) this.Swap(srcArray, j);
      }
    }
  ...
  SortShaker: function SortShaker(srcArray) {
    ...
    while (left < right) {
      for (var i = left; i < right; i++) {
        if (srcArray[i] > srcArray[i + 1]) this.Swap(srcArray, i);
      }

      right--;

      for (var _i = right; _i > left; _i--) {
        if (srcArray[_i - 1] > srcArray[_i]) this.Swap(srcArray, _i - 1);
      }
  ...
  this: Swap = function Swap(array, index) {
    var tmp = array[index];
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","js/arraySorter.js"], null)
//# sourceMappingURL=/arraySorter.3799ab15.js.map