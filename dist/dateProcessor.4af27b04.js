...
var dateProcessor = _defineProperty({
  ...
  DateParserWithPattern: function DateParserWithPattern(inString, inPattern) {
    var date = new Date(this.GetParsedString(inString, inPattern));
    return date.toString();
  },
  ...
  this: GetParsedString = function GetParsedString(inString, inPattern) {
    var innerDate = "";
...
}, "this", PasteDate = function PasteDate(date, toPattern) {
  var result = "";
  var i = 0;
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","js/dateProcessor.js"], null)
//# sourceMappingURL=/dateProcessor.4af27b04.js.map